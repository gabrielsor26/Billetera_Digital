 ...
 * @author Usuario
 */
public class Ventana_Inversion extends javax.swing.JFrame {

    int xMouse, yMouse;
    int xMouseCrema, yMouseCrema;

    public Ventana_Inversion() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        header.add(exitTxt, new org.netbeans.lib.awtextra.AbsoluteConstraints(490, -10, 50, 50));
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Ventana_Inversion.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new Ventana_Inversion().setVisible(true);
            }
        });
    }
