 ...
 * @author Usuario
 */
public class Ventana_BIPER extends javax.swing.JFrame {

    /**
     * Creates new form Ventana_BIPER
     */
    public Ventana_BIPER() {
        initComponents();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Ventana_BIPER.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new Ventana_BIPER().setVisible(true);
            }
        });
    }
