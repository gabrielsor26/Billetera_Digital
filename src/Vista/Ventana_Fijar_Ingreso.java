 ...
 * @author Usuario
 */
public class Ventana_Fijar_Ingreso extends javax.swing.JFrame {

    int xMouse, yMouse;
    int xMouseCrema, yMouseCrema;

    public Ventana_Fijar_Ingreso() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        txtFijarPresupuestoIngreso = new javax.swing.JLabel();
        ...
        txtBienvenida2.setForeground(new java.awt.Color(25, 113, 194));
        txtBienvenida2.setHorizontalAlignment(javax.swing.SwingConstants.CENTER);
        txtBienvenida2.setText("INGRESO");
        ...
        btnRegistrarIngreso1.setBackground(new java.awt.Color(25, 113, 194));
        btnRegistrarIngreso1.setLayout(new org.netbeans.lib.awtextra.AbsoluteLayout());

        txtFijarPresupuestoIngreso.setFont(new java.awt.Font("Roboto Mono", 1, 22)); // NOI18N
        txtFijarPresupuestoIngreso.setForeground(new java.awt.Color(255, 255, 255));
        txtFijarPresupuestoIngreso.setHorizontalAlignment(javax.swing.SwingConstants.CENTER);
        txtFijarPresupuestoIngreso.setText("<html><center>FIJAR<br>PRESUPUESTO<html>");
        btnRegistrarIngreso1.add(txtFijarPresupuestoIngreso, new org.netbeans.lib.awtextra.AbsoluteConstraints(0, 0, 180, 60));
        ...
        jtPrevisualizar.setSelectionBackground(new java.awt.Color(0, 153, 255));
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Ventana_Fijar_Ingreso.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                ...
                Ventana_Fijar_Ingreso frm = new Ventana_Fijar_Ingreso();
    ...
    public javax.swing.JComboBox<Datos_Categoria_Ingreso> cbxCategoria;
    ...
    public javax.swing.JLabel txtFijarPresupuestoIngreso;
