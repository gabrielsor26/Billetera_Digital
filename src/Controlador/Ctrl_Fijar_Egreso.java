...
import Vista.Ventana_Fijar_Egreso;
...
public class Ctrl_Fijar_Egreso implements MouseListener {

    private final Datos_Presupuestos datos;
    private final Consulta_Datos_Presupuestos consulta;
    private final Ventana_Fijar_Egreso vista;

    public Ctrl_Fijar_Egreso(Datos_Presupuestos datos, Consulta_Datos_Presupuestos consulta, Ventana_Fijar_Egreso vista) {
        this.datos = datos;
        this.consulta = consulta;
        this.vista = vista;

        //Botones
        this.vista.txtFijarPresupuestoEgreso.addMouseListener(this);
    ...
    public void mouseClicked(MouseEvent e) {
        if (e.getSource() == vista.txtFijarPresupuestoEgreso) {
            PreparedStatement ps = null;
            ResultSet rs = null;
            try {
